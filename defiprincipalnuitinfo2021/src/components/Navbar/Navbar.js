...
const pages = [["Interventions", "/interventions"], ["Sauveteurs", "/sauveteurs"], ["Sauves", "/sauves"]];
          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            >
              {settings.map((setting) => (
                <MenuItem key={setting} onClick={handleCloseNavMenu} component={Link} to={setting[1]}>
